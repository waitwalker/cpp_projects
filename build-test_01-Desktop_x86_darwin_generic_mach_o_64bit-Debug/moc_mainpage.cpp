...
QT_MOC_LITERAL(9, 18), // "hideMainPageSignal"
QT_MOC_LITERAL(28, 0) // ""

    },
    "MainPage\0hideMainPageSignal\0"
};
...
void MainPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->hideMainPageSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainPage::hideMainPageSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainPage::hideMainPageSignal()
{
